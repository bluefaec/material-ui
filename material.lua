...
blueface = {
		...
		Maximise = Color3.fromRGB(228, 229, 245),
		MaximiseAccent = Color3.fromRGB(165, 166, 184),
		NavBar = Color3.fromRGB(83, 101, 207),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(83, 101, 207),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(83, 101, 207),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(83, 101, 207),
		Content = Color3.fromRGB(83, 101, 207),
		Button = Color3.fromRGB(83, 101, 207),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(83, 101, 207),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(83, 101, 207),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(83, 101, 207),
		Toggle = Color3.fromRGB(83, 101, 207),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(83, 101, 207),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(83, 101, 207),
		TextField = Color3.fromRGB(83, 101, 207),
		TextFieldAccent = Color3.fromRGB(83, 101, 207),
	},
	Light = {
		MainFrame = Color3.fromRGB(255,255,255),
