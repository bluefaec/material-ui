...
Blueface = {
		...
		NavBar = Color3.fromRGB(72, 95, 232),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(72, 95, 232),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(72, 95, 232),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(72, 95, 232),
		Content = Color3.fromRGB(72, 95, 232),
		Button = Color3.fromRGB(72, 95, 232),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(72, 95, 232),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(72, 95, 232),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(72, 95, 232),
		Toggle = Color3.fromRGB(72, 95, 232),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(72, 95, 232),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(72, 95, 232),
		TextField = Color3.fromRGB(72, 95, 232),
		TextFieldAccent = Color3.fromRGB(72, 95, 232),
	},
	Light = {
		MainFrame = Color3.fromRGB(255,255,255),
